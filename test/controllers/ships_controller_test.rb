...
class ShipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ship" do
    assert_difference("Ship.count") do
      post ships_url, params: { ship: { crew_id: @ship.crew_id, location: @ship.location, name: @ship.name } }
    end
  ...
  test "should update ship" do
    patch ship_url(@ship), params: { ship: { crew_id: @ship.crew_id, location: @ship.location, name: @ship.name } }
