...
class CrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew" do
    assert_difference("Crew.count") do
      post crews_url, params: { crew: { island: @crew.island, name: @crew.name, sea: @crew.sea } }
    end
  ...
  test "should update crew" do
    patch crew_url(@crew), params: { crew: { island: @crew.island, name: @crew.name, sea: @crew.sea } }
